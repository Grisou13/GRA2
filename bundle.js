...
module.exports = function Hero() {
  ...
  document.addEventListener("scroll", function (e) {
    console.log(e);
    var scrollDown = document.querySelector(".scroll-helper");
...
},{"./hero":3,"./nav":5,"./polyfills":6,"jquery":1,"materialize-css/js/materialize":2}],5:[function(require,module,exports){
"use strict";
...
window.getTransitionProperty = function (element) {
